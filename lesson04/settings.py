...
#
#  heroku config:set DJANGO_SECRET_KEY='(@0o_uw45q*$k=mjroapm6x&wtdg*gp-vo7znrv=3j5-2u(s)u'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = '(@0o_uw45q*$k=mjroapm6x&wtdg*gp-vo7znrv=3j5-2u(s)u'
...
# WSGI configuration
# See https://docs.djangoproject.com/en/1.9/howto/deployment/wsgi/
...
# Django logging: https://docs.djangoproject.com/en/1.9/topics/logging/
